...
export const CATALOG_DESIGNS: DesignItem[] = [
  // Infantiles (Barbie / Hello Kitty / My Melody)
  {
    ...
    characterImg: '', // We won't strictly need characterImg for the catalog list, but for customizer
    ...
    description: 'Forro escolar adhesivo con fondo rosa pastel reglamentario y Hello Kitty. Incluye título de materia y nombre del alumno.',
    isPopular: true
  },
  {
    id: 'inf-2',
  ...
  {
    id: 'inf-9',
    title: 'Diseño Especial Niña - Variante',
    category: 'infantil',
    characterName: 'Personaje Especial',
    characterImg: '',
    image: '/images/infantiles/libretas barbie-09.jpg',
    bgColor: '#FFB6C1',
    bgType: 'solid',
    defaultSubject: 'Materias Varias',
    defaultStudentName: 'Barbie Sofía Pérez',
    subjectFont: 'Bubblegum Sans',
    studentFont: 'Pacifico',
    subjectGraphicStyle: 'style-pop-pink',
    description: 'Variante especial de diseño para forros adhesivos.',
    isPopular: false
  },
